...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::MyMainFrameGui*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("MyMainFrameGui", ::MyMainFrameGui::Class_Version(), "inc/MyMainFrameGui.h", 44,
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const map<int,TGSlider*>*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("map<int,TGSlider*>", -2, "map", 899,
...
"/Users/chad/Documents/GitHub/STCF/1-RICH/3-DESYBeam/",
0
    };
