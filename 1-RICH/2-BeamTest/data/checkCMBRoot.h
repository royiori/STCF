//----------
//分析数据控制参数
TString fName("RUN75"); //./DESY-BeamTest/RUN64/Combine/Combined-dst.root
...
vector<vector<double>> offset = {
    ...
    {75, -14.34, -0.9095, -1.016, -1.741, 0, 0}, // X
    {75, 18.44, 0.7583, 0.5443, -1.972, 0, 0},   // Y
    {75, 375, 0, 97, 875, 0, 0},                 // Z
    {75, 45},                                    // angle
